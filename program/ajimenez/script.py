...
def _split_data(df):
    ...
    #species_distribution = df_train['species'].value_counts(normalize=True)*100
    #print("Species Distribution in train:")
    #print(species_distribution)
    
    #species_distribution = temp['species'].value_counts(normalize=True)*100
    #print("Species Distribution in test:")
    #print(species_distribution)
